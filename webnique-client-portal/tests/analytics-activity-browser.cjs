...
(async()=>{
    ...
    try{
        ...
        assert.match(await page.$eval('#wnq-feed-lead_summary .wnq-lead-sentence',el=>el.textContent),/2 verified phone calls, 4 form submissions, and 2 email leads/);
