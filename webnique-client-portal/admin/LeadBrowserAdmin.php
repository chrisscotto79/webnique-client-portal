...
final class LeadBrowserAdmin
{
    ...
    public static function render(): void
    {
        ...
        <div id="lf-browser-app" data-user="<?php echo (int)get_current_user_id(); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('wnq_browser_leads')); ?>">
            ...
            </form><p>Searches the area around your ZIP; Google may include nearby businesses. All listings are saved. GHL outreach requires fewer than 50 reviews and a reviewed small independent business; franchises, large companies and unknown company types are held. Review these in Lead List.</p>
    ...
    public static function leads(): void
    {
        ...
        <section class="wnq-card"><h2>Outreach qualification</h2><p><strong>Default: fewer than 50 reviews, small independent businesses only.</strong> Franchises/chains, large companies and unreviewed businesses cannot be sent to GHL. Zero/missing review counts require verification and are held. All collected listings stay in this list for review or calling.</p>
