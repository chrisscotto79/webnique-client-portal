...
final class LeadGhlAdmin
{
    ...
    public static function render(): void
    {
        ...
        <p>Handoffs include the collected business phone when usable, including filling a blank phone on an existing matching GHL contact. Phone conflicts are held for review. Numbers are not verified as mobile/SMS-capable or opted in. Your GHL workflow must check SMS permission and opt-outs before texting. Leads without a usable phone remain email-only; an email is still required. Previously sent leads are not re-enrolled.</p>
        ...
        <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" onsubmit="return confirm('Retry contacts held by the old DND-field check? Missing DND will defer to GHL delivery suppression. Applying tags can start live emails. Other holds stay untouched.')">
